...
namespace Group50_Hotel_System
{
    public partial class Request_Report : Form
    {
        ...
        private void GetTop5Guests(DateTime startDate, DateTime endDate)
        {
            ...
            string query = @"
                SELECT TOP 5 
                    ...
                    g.First_Name, 
                    g.Last_Name, 
                    COUNT(gb.Booking_ID) AS BookingCount
                FROM 
                    Guests g
                JOIN 
        ...
        private void GetBusiestWeeks(DateTime startDate, DateTime endDate)
        {
            ...
            // Define the query with placeholders for the dates
            string query = @"
                SELECT 
        ...
        private void btnSearchWeeks_Click(object sender, EventArgs e)
        {
        ...
        private void btnClearWeeks_Click(object sender, EventArgs e)
        {
